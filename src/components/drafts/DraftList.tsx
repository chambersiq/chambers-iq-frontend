...
import { Edit3, MoreHorizontal, FileText, Trash2, ExternalLink } from 'lucide-react'
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
export function DraftList({ caseId }: DraftListProps) {
    // Filter drafts if caseId is provided
    const filteredDrafts = caseId
        ? MOCK_DRAFTS.filter(d => d.caseId === caseId)
        : MOCK_DRAFTS
